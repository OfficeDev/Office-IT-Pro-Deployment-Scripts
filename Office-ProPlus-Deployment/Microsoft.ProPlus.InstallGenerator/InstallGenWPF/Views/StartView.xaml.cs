    ...
    public partial class StartView : UserControl
    {
        ...
        private void ManageCM()
        {
            try
            {
                ...
                GlobalObjects.ViewModel.ApplicationMode = ApplicationMode.ManageCM;
        ...
        private void cbActions_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            switch (cbActions.SelectedIndex)
            {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    txtBlock.Text = "Select this option if you would like to mangage Office via your CM Server.";
                    break;
                default:
                    txtBlock.Text = "";
                    break;
