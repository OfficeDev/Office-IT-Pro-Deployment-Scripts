...
Generate-ODTConfigurationXml -Languages AllInUseLanguages -TargetFilePath $targetFilePath | Set-ODTAdd -Version $NULL -Channel Broad -SourcePath $SourcePath | Install-OfficeClickToRun
