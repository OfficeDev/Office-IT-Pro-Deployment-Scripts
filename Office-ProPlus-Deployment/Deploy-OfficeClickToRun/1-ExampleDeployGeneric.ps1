...
Generate-ODTConfigurationXml -Languages AllInUseLanguages -TargetFilePath $targetFilePath | Set-ODTAdd -Version $NULL -Channel SemiAnnual -SourcePath $SourcePath | Install-OfficeClickToRun
