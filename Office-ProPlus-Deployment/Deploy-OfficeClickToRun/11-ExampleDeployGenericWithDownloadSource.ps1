...
Generate-ODTConfigurationXml -Languages AllInUseLanguages -TargetFilePath $targetFilePath | Set-ODTAdd -Version $NULL -Channel Broad -DownloadPath $DownloadePath | Install-OfficeClickToRun
