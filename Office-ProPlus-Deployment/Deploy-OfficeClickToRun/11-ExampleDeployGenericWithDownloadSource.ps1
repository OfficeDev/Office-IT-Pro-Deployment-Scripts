...
Generate-ODTConfigurationXml -Languages AllInUseLanguages -TargetFilePath $targetFilePath | Set-ODTAdd -Version $NULL -Channel SemiAnnual -DownloadPath $DownloadePath | Install-OfficeClickToRun
