        ...
        success:
            function (xml) {
                ...
                $(xml).find('Build').each(function () {
                    var buildType = $(this).attr('DisplayName');
                                                            ...
                                                            <div class='ms-Grid-col ms-u-sm6 ms-u-smPush4 ms-u-md4 ms-u-mdPush2 ms-u-lg4 ms-u-lgPush4 ms-u-xl3 ms-u-xlPush4'>\
                                                                 <div class='ms-Grid'>\
                                                                    <div class='ms-Grid-row'>\
                                                                        <p class='ms-font-l type-label filter-field' style='white-space: nowrap;'>" + buildType + "</b></p><br />\
                                                                    </div>\
                                                                    <div class='ms-Grid-row'>\
        ...
        success:
            function (xml) {
                $(xml).find('Build').each(function () {
                    ...
                    var type = $(this).attr("DisplayName");
...
function resizeWindow() {
    ...
    var languagePrimaryBack = $("#languagePrimaryBack");
    var languagePrimaryTitle = $("#languagePrimaryTitle");
    ...
    if (miniBanner.is(':visible')) {
        ...
        buildListHeight = winHeight - topBarHeight.height() - searchBar.height() - miniBanner.height() - 40;
    } else {
        prodModelHeight = winHeight - topBarHeight.height() - banner.height();
        buildListHeight = winHeight - topBarHeight.height() - searchBar.height() - banner.height() - 40;
    }
    
    var primaryLanguageHeight = buildListHeight;

    $("#productModal").height(prodModelHeight);
    $("#productList").height(buildListHeight);
    $("#primaryLanguageList").height(primaryLanguageHeight);
